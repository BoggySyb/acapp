...
requestAnimationFrame(AC_GAME_ANIMATION);class GameMap extends AcGameObject {
    ...
    start() {
        if (this.charecter === "me") {
            this.add_listening_events();
        } else if (this.charecter === "robot") {
    ...
    constructor(playground) {
        ...
        this.ws = new WebSocket("wss://app6206.acapp.acwing.com.cn/wss/multiplayer/");
            ...
            <div class="ac-game-settings">
                <div class="ac-game-settings-login">
                    ...
                    <div class="ac-game-settings-acwing">
                        <img width="30" src="https://app6206.acapp.acwing.com.cn/static/image/settings/acwing_logo.png">
                        <br>
                        <div>AcWing 一键登录</div>
                    </div>
                </div>
    ...
    login_on_remote() { // 在远程服务器上登录
        ...
        $.ajax({
           url: "https://app6206.acapp.acwing.com.cn/settings/login/",
            type: "GET",
            data: {
               username: username,
                password: password,
    ...
    register_on_remote() { // 在远程服务器上注册
        ...
        $.ajax({
           url: "https://app6206.acapp.acwing.com.cn/settings/register/",
           type: "GET",
           data: {
               username: username,
               password: password,
    ...
    logout_on_remote() { // 在远程服务器上登出
        if (this.platform === "acapp") {
            ...
            $.ajax({
                url: "https://app6206.acapp.acwing.com.cn/settings/logout/",
                type: "GET",
                success: function (resp) {
                    if (resp.result === "success") {
                        location.reload();
